...
const RBAC = (() => {
    ...
    return {
        ...
        applyToUI() {
            ...
            // ── إخفاء أزرار الحذف للموظف/السكرتير/المدرس ──
            if (role === 'employee' || role === 'secretary' || role === 'teacher') {
...
function showSection(sectionId, btnEl) {
    ...
    const titles = {
        ...
        'teacher-accounts': 'إنشاء الحسابات — نظام المدرسين'
    };
